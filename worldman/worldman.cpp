...
// Load data by entID
bool loadEntity (int id, int type) {
    Fileman tmp;
    ...
    //printf("TEST: %f\n\n\n", tmp.data[1].get("s_gravity", 0).asDouble());
...
int createEntity (int type, int subtype, int parID) {
